...
public class AppointmentDao {
	...
	public boolean addAppointment(Appointment ap) {
		...
		try {
			String sql = "insert into appointment (user_id,full_name,gender,dob,appointment_date,email,phno,diseases,doctor_id,address,status)values(?,?,?,?,?,?,?,?,?,?,?)";
